...
when attempting to analyse and utilize unstructured
or semi-structured data derived from raw text documents or spreadsheets.
The absence of a defined structure within this data
presents significant challenges for analysis and utilization. 


In some instances,
the data is entirely unstructured,
with crucial information buried within raw text,
rendering it inaccessible for analysis.
This necessitates the creation of a data collection form
and database by a software developer prior to data collection.
